...
const CACHE = "toji-fit-v7";
const ASSETS = [
  "./", "./index.html", "./manifest.json",
  "./css/style.css?v=7",
  "./js/firebase-config.js?v=7", "./js/store.js?v=7", "./js/engine.js?v=7", "./js/auth.js?v=7",
  "./js/view-rutina.js?v=7", "./js/view-entrenar.js?v=7", "./js/view-comer.js?v=7", "./js/view-guias.js?v=7", "./js/view-amigos.js?v=7", "./js/view-yo.js?v=7",
  "./js/main.js?v=7",
